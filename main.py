...
class Comet:
    def __init__(self, screen, width, height):
        ...
        self.vertices = [(0, 0), (10, -5), (5, 5), (0, 5), (0, 0)]  # Координаты вершин кометы
        self.x = self.width
        self.y = 0
        self.speed_x = -0.1
        self.speed_y = 0.1
    ...
    def update(self):
        ...
        if self.x < 0 or self.y > self.height:
            self.x = self.width
            self.y = 0
    ...
    def move(self):
        ...
        if self.size > 10:  # Ограничение размера кометы
            self.size = 10
...
comet = Comet(screen, WIDTH, HEIGHT)

rocket = Rocket1(screen, 100, 100)
